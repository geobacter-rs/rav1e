...
#[cfg(feature = "unused-reference-impls")]
fn av1_iflipadst4(input: &[i32], output: &mut [i32], range: usize) {
...
#[cfg(feature = "unused-reference-impls")]
fn av1_iflipadst8(input: &[i32], output: &mut [i32], range: usize) {
...
#[cfg(feature = "unused-reference-impls")]
fn av1_iflipadst16(input: &[i32], output: &mut [i32], range: usize) {
